...
const Navbar = () => {
  const navLists = (
    <>
      <li className="font-semibold text-base hover:text-fuchsia-600">
        <a href="#home">Home</a>
      </li>
      <li className="font-semibold text-base hover:text-fuchsia-600">
  ...
  return (
    <div className=" bg-gray-900">
      <div className="navbar bg-gray-900 text-white max-w-7xl mx-auto">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost md:text-2xl text-fuchsia-300">
