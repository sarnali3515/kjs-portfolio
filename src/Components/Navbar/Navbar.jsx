        ...
        <div>
            <div className="navbar bg-gray-900 text-white">
                ...
                <div className="navbar-end">
                    <a href='/Sarnali-Resume-frontend.pdf' target='_blank' download="Sarnali-Resume-frontend.pdf" className="btn text-fuchsia-500 text-xs md:text-lg hover:bg-fuchsia-600 hover:text-white font-medium border-fuchsia-500 bg-transparent md:mr-4">Resume</a>
                </div>
            </div>
        </div>
    );
